...
UPDATE_FREQUENCY = 5   # lowwered to adjust for pour performance on local machine
...
class WaypointUpdater(object):
    def __init__(self):
        ...
        rospy.loginfo('Waypoint updater running')
    ...
    def get_closest_waypoint_index(self):
        ...
        # Check if closest point is ahead or behind the car
        closest_coordinate = self.waypoints_2d[closest_index]
        previous_coordinate = self.waypoints_2d[closest_index - 1]
        ...
        check_value = np.dot(closest_vector - previous_vector, position_vector - closest_vector)
    ...
    def decelerate_waypoints(self, waypoints, closest_index):
        ...
        for i, wp in enumerate(waypoints):
            ...
            # 2 waypoints back from line so fron of cars stops at line
    ...
    def traffic_cb(self, msg):
        ...
        #rospy.logerr('Have a stopline: %s' % self.stopline_wp_index)
